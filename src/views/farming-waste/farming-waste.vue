        ...
        <el-container>
                            ...
                            <el-col :span="24">
                                <el-form-item label="地(市):">
                                    <el-select v-model="formData.land" placeholder="请选择省(市)" clearable>
                                        <el-option v-for="(item, index) in land" :key="index" :label="item.label"
                                                   :value="item.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="24">
                                <el-form-item label="县(旗):">
                                    <el-select v-model="formData.county" placeholder="请选择省(市)" clearable>
                                        <el-option v-for="(item, index) in county" :key="index" :label="item.label"
                                                   :value="item.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="24">
                                <el-form-item label="乡(镇):">
                                    <el-select v-model="formData.town" placeholder="请选择省(市)" clearable>
                                        <el-option v-for="(item, index) in town" :key="index" :label="item.label"
                                                   :value="item.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="24">
                                <el-form-item label="村(组):">
                                    <el-select v-model="formData.group" placeholder="请选择省(市)" clearable>
                                        <el-option v-for="(item, index) in group" :key="index" :label="item.label"
                                                   :value="item.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="24">
                                <el-form-item label="编号:">
                                    <el-select v-model="formData.workCars" placeholder="请选择作业车辆" clearable>
                                        <el-option v-for="(item, index) in workCars" :key="index" :label="item.label"
                                                   :value="item.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="24">
                                <el-form-item label="作业:">
                                    <el-select v-model="formData.workType" placeholder="请选择作业车辆" clearable>
                                        <el-option v-for="(item, index) in workType" :key="index" :label="item.label"
                                                   :value="item.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
            ...
            <el-dialog title="农业废弃物回收记录" :visible.sync="dialogVisible" top="25%" width="1000px">
                <el-descriptions :column="3" border>
                    ...
                    <el-descriptions-item label="联系地址" :contentStyle="{'text-align': 'right'}">{{showdata.nfaddress}}
                    </el-descriptions-item>
                </el-descriptions>
            ...
            setOptions1() {
                ...
                $.ajax({
                    ...
                    "success": function (response) {
                        ...
                        var curve = [response.data[2021], response.data[2022], response.data[2023], response.data[2024], response.data[2025], response.data[2026]]
